    ...
    <div className='bg-[#050922] py-20 max-md:px-4' id="services">
      <div className='flex flex-col items-center'>
        ...
        <m.p className='text-md text-center font-medium text-[#B4B4B4] max-w-[800px]' initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:0.2, duration:1}}>
          I provide a full range of data management services
        </m.p>
      </div>
      <m.div className='flex items-center justify-between w-full my-10' initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:0.4, duration:1}}>
        <ServiceCard />
      </m.div>
    </div>
  );
